            ...
            <div class="modal-body">
                <div class="mb-2 col-sm-12">
                    ...
                    <div class="col-sm-12 my-2 p-0 text-right">
                        <button type="button" class="btn btn-primary" id="setUserStatus">{{__('messages.save')}}</button>
                        <button type="button" class="btn btn-secondary" id="clearUserStatus">{{__('messages.partials.clear_status')}}</button>
                    </div>
                </div>
            </div>
        </div>
