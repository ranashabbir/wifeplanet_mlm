...
return [
    ...
    */
    ...
    'buttons' => [
        ...
        'delete'        => '<i class="far fa-trash-alt fa-fw" aria-hidden="true"></i>',
        'show'          => '<i class="fas fa-eye fa-fw" aria-hidden="true"></i>',
        'edit'          => '<i class="fas fa-pencil-alt fa-fw" aria-hidden="true"></i>',
        ...
        'delete-user'   => '<i class="far fa-trash-alt fa-fw" aria-hidden="true"></i>',
        'edit-user'     => '<i class="fas fa-pencil-alt fa-fw" aria-hidden="true"></i>',
    ],
